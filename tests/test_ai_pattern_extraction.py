...
# Configuration
TEST_SAMPLE_SIZE = 5  # Start with 5 images for faster testing (increase later)
API_KEY_ENV = "GEMINI_API_KEY"  # Environment variable name for API key
MODEL_NAME = "models/gemini-1.5-flash"  # Daha yüksek günlük limit (1500/gün ücretsiz tier)
...
if os.path.exists('test_ai_pattern_results.csv'):
    try:
        previous_results = pd.read_csv('test_ai_pattern_results.csv')
...
test_output_file = "test_ai_pattern_results.csv"
